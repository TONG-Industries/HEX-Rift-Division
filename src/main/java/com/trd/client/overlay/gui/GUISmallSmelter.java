// com/trd/client/overlay/gui/GUISmallSmelter.java
...
public class GUISmallSmelter extends AbstractContainerScreen<SmallSmelterMenu> {
    private static final ResourceLocation TEXTURE = new ResourceLocation(MainRegistry.MOD_ID, "textures/gui/machine/small_smelter_gui.png");
