...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> writer) {
        ...
        SimpleCookingRecipeBuilder.smelting(
                ...
                .save(writer, MainRegistry.MOD_ID + ":dolomite_brick_from_smelting");
        ...
        SingleItemRecipeBuilder.stonecutting(
                ...
                .unlockedBy("has_firebrick_block", has(ModBlocks.FIREBRICK_BLOCK.get()))
                .save(writer, MainRegistry.MOD_ID + ":firebrick_slab_from_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(
                ...
                .unlockedBy("has_firebrick_block", has(ModBlocks.FIREBRICK_BLOCK.get()))
                .save(writer, MainRegistry.MOD_ID + ":firebrick_stairs_from_stonecutting");
...
// === REINFORCED BRICK ===
        ...
        SingleItemRecipeBuilder.stonecutting(
                ...
                .unlockedBy("has_reinforcedbrick_block", has(ModBlocks.REINFORCEDBRICK_BLOCK.get()))
                .save(writer, MainRegistry.MOD_ID + ":reinforcedbrick_slab_from_stonecutting");
        ...
        SingleItemRecipeBuilder.stonecutting(
                ...
                .unlockedBy("has_reinforcedbrick_block", has(ModBlocks.REINFORCEDBRICK_BLOCK.get()))
                .save(writer, MainRegistry.MOD_ID + ":reinforcedbrick_stairs_from_stonecutting");
